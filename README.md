...
![React](https://img.shields.io/badge/React-B0E0E6?style=for-the-badge&logo=react&logoColor=black)
![NumPy](https://img.shields.io/badge/NumPy-C8A2C8?style=for-the-badge&logo=numpy&logoColor=black) <br>
![Pandas](https://img.shields.io/badge/Pandas-E6E6FA?style=for-the-badge&logo=pandas&logoColor=black)
...
>- 동시성 제어 및 자료구조 최적화를 통한 성능 향상 수행

### 모바일 플랫폼
>- Figma를 활용해 냉장고 관리 앱의 프로토타입을 설계하고, 전체 UI·UX 플로우를 기획함  
>- 팀 프로젝트로 데이터베이스 구조 및 주요 라이브러리 구성을 직접 설계하며 앱 기능을 정의함  
>- 실제 코딩 대신 앱 동작 시나리오와 화면 전환 흐름을 시각적으로 구현하여 사용자 중심의 설계 경험을 쌓음
